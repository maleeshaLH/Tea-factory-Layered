...
import lk.Ijse.TeaFctory.model.SupplierPlaceOrderModel;
...
public class SupplierOrderFormController {
    ...
    private void generateNextSupplierOrderId() {
        try {
            String orderId = supplierOrderBO.generateNextOrderId();
    ...
    private void loadRawStockIds() {
        ...
        try {
            List<RawStockDto> supList = rawStockBO.getAllRawStock();
    ...
    public void cmbRawStockOnsction(ActionEvent event) {
        ...
        try {
            RawStockDto dto = rawStockBO.searchRawStock(rs_id);
